...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:i can glow2@localhost:5432/omnispa'
    ...
    def load_user(user_key):
        ...
        if "-" in user_key:  # new format
            ...
            return None  # Force re-login for old sessions
